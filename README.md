...
tl;dr: mostly hand-written, very little LLM code.
...
I've occasionally used them for small boring pieces around the edges.

I have used LLMs for design conversations, tracking down bugs, and code reviews.
