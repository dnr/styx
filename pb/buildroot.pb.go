...
type BuildRootMeta struct {
	...
	CharonBuild string `protobuf:"bytes,4,opt,name=charon_build,json=charonBuild,proto3" json:"charon_build,omitempty"`
}
...
var file_buildroot_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22, 0x90, 0x01,
